...
goog.exportSymbol('proto.stella.book.v1.SearchBookRequest', null, global);
goog.exportSymbol('proto.stella.book.v1.SearchBookResponse', null, global);
/**
 ...
 * @constructor
 */
proto.stella.book.v1.SearchBookRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.stella.book.v1.SearchBookRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.stella.book.v1.SearchBookRequest.displayName = 'proto.stella.book.v1.SearchBookRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.stella.book.v1.SearchBookResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.stella.book.v1.SearchBookResponse.repeatedFields_, null);
};
goog.inherits(proto.stella.book.v1.SearchBookResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.stella.book.v1.SearchBookResponse.displayName = 'proto.stella.book.v1.SearchBookResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.stella.book.v1.ListBooksRequest.prototype.getFilter = function() {
 ...
 * @return {!Object}
 */
proto.stella.book.v1.SearchBookRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.stella.book.v1.SearchBookRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.stella.book.v1.SearchBookRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stella.book.v1.SearchBookRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.stella.book.v1.SearchBookRequest}
 */
proto.stella.book.v1.SearchBookRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.stella.book.v1.SearchBookRequest;
  return proto.stella.book.v1.SearchBookRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.stella.book.v1.SearchBookRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.stella.book.v1.SearchBookRequest}
 */
proto.stella.book.v1.SearchBookRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.stella.book.v1.SearchBookRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.stella.book.v1.SearchBookRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.stella.book.v1.SearchBookRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stella.book.v1.SearchBookRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIsbn();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.stella.book.v1.SearchBookRequest.prototype.getIsbn = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.stella.book.v1.SearchBookRequest.prototype.setIsbn = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.stella.book.v1.SearchBookResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.stella.book.v1.SearchBookResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.stella.book.v1.SearchBookResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.stella.book.v1.SearchBookResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stella.book.v1.SearchBookResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    booksList: jspb.Message.toObjectList(msg.getBooksList(),
    proto.stella.book.v1.Book.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.stella.book.v1.SearchBookResponse}
 */
proto.stella.book.v1.SearchBookResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.stella.book.v1.SearchBookResponse;
  return proto.stella.book.v1.SearchBookResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.stella.book.v1.SearchBookResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.stella.book.v1.SearchBookResponse}
 */
proto.stella.book.v1.SearchBookResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.stella.book.v1.SearchBookResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.stella.book.v1.SearchBookResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.stella.book.v1.SearchBookResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.stella.book.v1.SearchBookResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBooksList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.stella.book.v1.Book>}
 */
proto.stella.book.v1.SearchBookResponse.prototype.getBooksList = function() {
  return /** @type{!Array<!proto.stella.book.v1.Book>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.stella.book.v1.Book, 1));
};
...
/** @param {!Array<!proto.stella.book.v1.Book>} value */
proto.stella.book.v1.SearchBookResponse.prototype.setBooksList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.stella.book.v1.Book}
 */
proto.stella.book.v1.SearchBookResponse.prototype.addBooks = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.stella.book.v1.Book, opt_index);
};
 ...
 * Clears the list making it empty but non-null.
 */
proto.stella.book.v1.SearchBookResponse.prototype.clearBooksList = function() {
  this.setBooksList([]);
};
